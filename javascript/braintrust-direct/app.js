 ...
 *   - BraintrustSpanProcessor (from @braintrust/otel) routes spans to
 *     Braintrust via the x-bt-parent header.
 *   - BatchSpanProcessor(OTLPTraceExporter) ships the same spans to Last9.
 *
...
const provider = new NodeTracerProvider({
  resource: resourceFromAttributes({
    [ATTR_SERVICE_NAME]: process.env.OTEL_SERVICE_NAME || 'braintrust-direct-example',
...
const tracer = trace.getTracer('braintrust-direct-example');
