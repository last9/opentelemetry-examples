...
1. After testing with `console` exporter, switch to `otlp` in your `.env` file
2. Trigger some requests to generate traces
3. View your traces in the [Last9 Dashboard](https://app.last9.io)
